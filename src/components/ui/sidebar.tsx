    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          ((variant === "floating" || variant === "inset") || overlay)
            ? "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4)))]"
            : "group-data-[collapsible=icon]:w-(--sidebar-width-icon)",
          // If overlay is true, force the width to be the collapsed width even when expanded
...
function SidebarMenuButton({
  ...
  // Filter out Figma internal props that start with _fg
